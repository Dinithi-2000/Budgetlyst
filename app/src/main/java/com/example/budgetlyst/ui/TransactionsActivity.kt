...
import com.example.budgetlyst.databinding.ActivityTransactionsBinding
...
class TransactionsActivity : AppCompatActivity(), TransactionsAdapter.OnTransactionClickListener {
    ...
    private fun setupTransactionsList() {
        adapter = TransactionsAdapter(getFilteredTransactions(), preferencesManager.getCurrencySymbol(), this)
